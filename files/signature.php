...
<div class="content fade">
	<div class="page-title hide">
		<h3>Crea tu firma oficial</h3>
	</div>
	<div class="row">
		<div class="col-md-12">
			<div class="light-card signature-card text-center">
        <h4 class="title-message"><span class="block-title color-primary block m-b-0"><b>Crea tu firma</b></span><span class="color-gray">Dibuja la firma que aparece en tu cedula de identidad.</span></h4>
			<div class="signature-holder">
				<img src="uploads/signatures/<?php echo $signature; ?>" class="img-responsive">
			</div>
			<div class="signature-btn-holder">
				<button class="btn btn-primary "  data-toggle="modal" data-target="#updateSignature"> <i class="ion-edit"></i> Dibujar</button>
			</div>
			</div>
		</div>
...
<?php include_once("../includes/footer.php"); ?>
  ...
  <div class="modal fade" id="updateSignature" role="dialog">
    <div class="modal-dialog">
      ...
      <ul class="head-links">
      	<li class="active"><a data-toggle="tab" href="#draw">Dibujar</a></li>
        <li class=""><a data-toggle="tab" href="#upload">Subir imagen</a></li>
      </ul>
        ...
        <div class="modal-footer">
          ...
          <button type="button" onclick="location.href='dashboard'" class="btn btn-primary save-signature-text">Guardar Firma</button>
        </div>
      </div>
