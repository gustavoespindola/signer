...
<div class="content fade" style="margin: 0 auto;">
		<div class="login-card">
			...
			<div class="sign-in" style="display: none;" <?php if($action == "reset" or $action == "forgot"){ ?> style="display: none;" <?php } ?>>
				<h4 class="title-message"><span class="block-title color-primary block m-b-0"><b>Ingresa a tu cuenta</b></span><span class="color-gray">Get starter absolutely free. No credit card needed.</span></h4>
				<!-- Messages -->
			...
			<!--  -->
			<div class="sign-up">
				<h4 class="title-message"><span class="block-title color-primary block m-b-0"><b>Create your account</b></span><span class="color-gray">Get starter absolutely free. No credit card needed.</span></h4>
				<!-- Messages -->
				<?php if(isset($msg['signupsuccessful'])) { ?>
				<div class="alert alert-success alert-dismissable">
					<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
